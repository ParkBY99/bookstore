<nav class="main-header navbar navbar-expand navbar-diy-orange navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown mr-3 mt-0">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a class="dropdown-item-title">
                    <div class="text-center p-3">
                        <img class="img-circle" style="width: 75px;"
                             src="{{asset(session()->get('admin')->user_img)}}"
                ...
                <div href="#" class="dropdown-item-text p-3 text-center">
                    <div class="btn-group float-left">
                        <a class="btn btn-outline-diy" data-toggle="modal" data-target="#modal-pswd">
                            <i class="nav-icon fas fa-user-cog"></i>
                        </a>
                    </div>
                    <div class="btn-group">
                        <a class="btn btn-outline-diy" data-toggle="modal" data-target="#modal-newUser">
