                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select id="classesCategory" class="form-control custom-select">
                            <option selected disabled>{{$class->category->name}}</option>
                    ...
                    <div class="form-group">
                        <div class="layui-upload">
                            <div class="layui-upload-list float-left">
                                <img class="layui-upload-img demoUp" src="{{asset($class->classes_img)}}" id="demo2" style="width: 100px; height: 125px; border-radius: 5px; border: 1px dashed lightgray;" onclick="uploadBtn(2)">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="classesDescription" class="form-control" rows="5" value="{{$class->description}}"></textarea>
                    </div>
                    <div class="row">
                        <div class="col-12" style="text-align: center;">
                            <button type="submit" class="btn btn-add btn-lg" onclick="Edit(2,{{$class->id}})">&ensp;&ensp;&ensp;添&ensp;&ensp;&ensp;加&ensp;&ensp;&ensp;</button>
