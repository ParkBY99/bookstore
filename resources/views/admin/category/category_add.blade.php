                    ...
                    <div class="form-group">
                            <div class="layui-upload">
                                <div class="layui-upload-list float-left">
                                    <img class="layui-upload-img demoUp" src="{{asset('/Bookstore/uploads/uploadDefault.png')}}" id="demo1" style="width: 100px; height: 125px;border-radius: 5px; border: 1px dashed lightgray" onclick="uploadBtn(1)">
                                </div>
